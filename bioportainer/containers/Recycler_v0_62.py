...
class Recycler_v0_62(MultiCmdContainer):
...
"""
    ...
    def run(self, graph_io, bam_io, subcmd="recycle", k=""):
        ...
        if subcmd == "recycle":
            ...
            self.cmd = [subcmd + ".py", "-o", self.out_dir] + graph + k + bam + self.get_opt_params("recycle_params")
...
recycler_v0_62 = Recycler_v0_62("customcontainers/recycler:0.62", "containers/dockerfiles/recycler_v0_62",
